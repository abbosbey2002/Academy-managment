                ...
                <div class="row flex-1 g-0">
                    <div class="col-lg-6 h-100 my-auto order-1 order-lg-0">
                        <div class="wd-50 bg-white p-2 rounded-circle shadow-lg position-absolute translate-middle top-50 start-50 d-none d-lg-block">
                            <img src="assets/images/academy_favicon.png" alt="" class="img-fluid">
                        </div>
                        <div class="creative-card-body card-body p-sm-5">
                            ...
                            <div class="w-100 mt-5 text-center mx-auto">
                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-light-brand flex-fill" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Login with Instagram">
                                        <i class="feather-instagram"></i>
                                    </a>
                                    <a href="{{ route('student.login') }}" class="btn btn-light-brand flex-fill" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Login for Students">
                                        {{ __('messages.auth.for_student') }}
                                    </a>
                                </div>
                            </div>
                            <div class="mt-5 text-muted">
                                <span>{{ __('messages.auth.have_an_account') }}</span>
                                <a href="{{ route('register') }}" title="Register" class="fw-bold">{{ __('messages.auth.create_acc') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 bg-primary order-0 order-lg-1">
                        <div class="h-100 d-flex align-items-center justify-content-center">
                            <img src="assets/images/auth/user-cover.webp" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
